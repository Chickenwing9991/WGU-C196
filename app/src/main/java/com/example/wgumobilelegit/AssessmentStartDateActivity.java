...
public class AssessmentStartDateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.assessment_details_add_start);

        // Initialize the CalendarView and Button
        CalendarView calendarView = findViewById(R.id.assessment_details_startDate);
        Button SaveButton = findViewById(R.id.assessment_details_StartDateOK);

        // Set an OnClickListener for the SaveButton
        SaveButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Create a new intent to go back to the AssessmentAddActivity
                Intent intent = new Intent(AssessmentStartDateActivity.this, AssessmentAddActivity.class);
